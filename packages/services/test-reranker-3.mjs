...
async function run() {
  ...
  console.log("Relevant:", await pipe(`${query} [SEP] ${doc1}`, { topk: null, function_to_apply: "none" }));
  console.log("Irrelevant:", await pipe(`${query} [SEP] ${doc2}`, { topk: null, function_to_apply: "none" }));
}
run();
